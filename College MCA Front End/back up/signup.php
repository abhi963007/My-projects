...
<body>
    <main>
        <section class="form">
            ...
            <p class="form__description">Please, fill in your details to sign up</p>
            ...
            <form action="signup_action.php" method="POST">
                ...
                <!-- User Type Dropdown -->
                <label class="form-control__label">Signup as:</label>
                ...
                <!-- Submit Button -->
                <button type="submit" class="form__submit" id="submit">Sign Up</button>
            </form>
